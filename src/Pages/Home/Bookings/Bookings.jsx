              ...
              <tr key={b._id}>
                <td>
                  <button
                    ...
                    className="bg-black rounded-full p-4 text-white"
                  >
                    <svg
                ...
                <th>
                  {b.status === "Confirm" ? (
                    <span className="py-2 px-4 border-2 border-green-400 bg-white text-green-400 rounded-lg">
                      Aproved
                    </span>
                  ) : (
                    <button
                      onClick={() => handleStatus(b._id)}
                      className="px-4 py-2 text-white font-semibold bg-orange-600 rounded-lg"
                    >
                      Pending
                    </button>
                  )}
